...
class _DictWrapper(object):
    ...
    def Copy(self, name=None):
        """
        使用copy模块获得一个浅赋值，同时复制了字典和name属性
        返回一个新的实例
        """
        new = copy.copy(self)
